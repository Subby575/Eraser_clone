...
function Hero() {
  return (
   ...
   <section className="bg-black">
    ...
    <h2 className='rounded-full justify-center text-center text-white border px-3 p-2'>See what&apos;s new | 
        <span className='text-sky-200'> AI Diagrams &gt;</span>

</h2>
    </div>
  <div className="mx-auto max-w-screen-xl px-4 py-6 h-screen  lg:h-screen lg:items-center">
